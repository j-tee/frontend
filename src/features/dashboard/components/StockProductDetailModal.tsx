              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 shadow-sm">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="text-sm text-slate-600 mt-1">SKU: {stockProduct.product_sku ?? '—'}</div>
                  </div>
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-2">
                  <div className="rounded-lg border border-slate-200 bg-white p-3">
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Warehouse</div>
                    <div className="text-sm font-medium text-slate-900">
                      {stockProduct.warehouse_name ?? warehouse?.name ?? '—'}
                    </div>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white p-3">
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Batch</div>
                    <div className="text-sm font-medium text-slate-900">
                  ...
                  <div className="rounded-lg border border-slate-200 bg-white p-3">
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Quantity</div>
                    <div className="text-sm font-semibold text-slate-900">{stockProduct.quantity.toLocaleString()}</div>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white p-3">
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Landed cost</div>
